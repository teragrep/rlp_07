...
Internal component logging levels can be managed with "-Dloglevel=info". You can read more about logging levels https://logback.qos.ch/apidocs/ch.qos.logback.classic/ch/qos/logback/classic/Level.html[here].
