...
Internal component logging levels can be managed with "-Dloglevel=info". You can read more about logging levels https://www.slf4j.org/apidocs/org/slf4j/simple/SimpleLogger.html[here].
