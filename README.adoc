...
Internal component logging levels can be managed with "-Dloglevel=info". You can read more about logging levels https://javadoc.io/doc/ch.qos.logback/logback-classic/1.4.6/ch.qos.logback.classic/ch/qos/logback/classic/Level.html[here].

[source, bash]
----
java -Dloglevel=debug -jar rlp_07.jar
----
